...
<ol>
  ...
  <li><strong>Publicas</strong> una oferta relámpago (con cuenta atrás y aforo) o un evento con fecha. Desde el móvil o desde el <a href="/panel/">panel del ordenador</a>.</li>
...
FAQ_ES = [
    ...
    ('¿Cómo borro mi cuenta?', 'Desde Perfil → Eliminar mi cuenta. Se borra todo lo tuyo. También puedes pedirlo por correo: <a href="/eliminar-cuenta/">cómo hacerlo</a>.'),
    ('Soy un negocio, ¿cómo me doy de alta?', 'Desde la app: Perfil → Dar de alta mi negocio (hace falta la ubicación exacta del local). Lo revisamos y te verificamos, normalmente en 24-48 horas. Luego puedes publicar desde el móvil o desde el <a href="/panel/">panel</a>.'),
...
FAQ_EN = [
    ...
    ('How do I delete my account?', 'From Profile → Delete my account. Everything of yours is deleted. You can also ask by email: <a href="/en/delete-account/">how to do it</a>.'),
    ('I am a business, how do I register?', 'From the app: Profile → Register my business (it needs the venue’s exact location). We check it and verify you, usually within 24-48 hours. After that you can publish from your phone or from the <a href="/panel/">dashboard</a>.'),
