...
const I18N = makeI18N({
  ...
  "Escribe el premio (sé concreto: «un café con leche gratis»).": "Write the reward (be specific: “a free coffee”).",
    ...
    // ── Cifras, «Más», programar, novedades con foto, cerrar por hoy ──
    "Cifras": "Stats",
    "Más": "More",
    "Crear a partir de esta": "Create from this one",
    "Repetir mañana": "Repeat tomorrow",
    "Repetir cada semana…": "Repeat every week…",
    "Cartel para imprimir": "Printable poster",
    "A partir de otra publicación": "From another publication",
    "Conversión": "Conversion",
    "Últimos 14 días": "Last 14 days",
    "Todavía nadie la ha visto. En cuanto lleguen visitas y canjes, los verás aquí día a día.": "Nobody has seen it yet. As soon as views and redemptions come in, you will see them here day by day.",
    "Asistencia": "Attendance",
    "Reservas": "Bookings",
    "Han entrado": "Checked in",
    "Si viene todo el mundo": "If everyone comes",
    "El cobro es tuyo, en la puerta: aquí solo contamos plazas a precio de tarifa.": "You take the payment at the door: here we only count places at list price.",
    "Cerrar": "Close",
    "O publicarla sola más tarde": "Or publish it automatically later",
    "Se guarda en borrador y se publica sola a esa hora (para dejar preparada la del lunes el viernes).": "It is saved as a draft and goes live on its own at that time (to get Monday’s ready on Friday).",
    ...
    "Borrar plantillas": "Delete templates",
    "Marca las que ya no uses. Las publicaciones hechas con ellas no cambian.": "Tick the ones you no longer use. Publications made with them do not change.",
    "Plantilla borrada": "Template deleted",
    "Plantillas borradas": "Templates deleted",
    "Foto": "Photo",
    "opcional": "optional",
    "Quitar la foto que tiene": "Remove its current photo",
    "Escribe algo o añade una foto.": "Write something or add a photo.",
    "Cerrado por hoy": "Closed today",
    "Cerrar por hoy": "Close for today",
    "Abrir de nuevo": "Open again",
    "Abierto de nuevo": "Open again",
    "Ahora mismo no se ve nada de tu negocio. Mañana vuelve a verse solo.": "Right now nothing from your business is shown. Tomorrow it shows again on its own.",
    ...
    'Sábado': 'Saturday',
    'Domingo': 'Sunday',
    "Ampliar 1 h": "Extend by 1 h",
    "Esa oferta ya ha terminado. Puedes repetirla mañana.": "That offer has already ended. You can repeat it tomorrow.",
    "Una oferta flash dura como mucho 24 h. Para más, crea un evento o repítela otro día.": "A flash offer lasts 24 h at most. For longer, create an event or repeat it another day.",
    "Diseño del anuncio": "Ad design",
    "Así se verá en Descubre. Elige la plantilla y el color que mejor casen con tu marca.": "This is how it will look in Discover. Pick the template and colour that match your brand.",
    "Cristal": "Glass",
    "Color": "Colour",
    "Póster": "Poster",
    "Limpio": "Clean",
    "Color de tu marca": "Your brand colour",
    ...
    "Este panel solo funciona por HTTPS": "This panel only works over HTTPS",
    "La del negocio": "The business's",
    "Imprímelo en blanco y negro si quieres: el código se lee igual.": "Print it in black and white if you like: the code scans just the same.",
    "No hemos podido cargar tu ficha.": "We could not load your business page.",
    "Escribe los tramos como «09:00-14:00, 17:00-21:00». Déjalo vacío el día que cierres.": "Write the slots like “09:00-14:00, 17:00-21:00”. Leave it empty on days you are closed.",
    "Todavía no has escrito la carta.": "You haven't written your menu yet.",
    "Un café con leche gratis": "A free white coffee",
    "Has llegado al límite de publicaciones activas de tu plan.": "You've reached your plan's limit of active publications.",
    "Esa publicación ya estaba copiada en ese local.": "That publication was already copied to that place.",
    "No has marcado ningún local.": "You haven't ticked any place.",
    "Demasiados locales de una vez.": "Too many places at once.",
    "Los sellos para el premio tienen que estar entre 2 y 20.": "The stamps for the reward must be between 2 and 20.",
    "Escribe qué premio se lleva la gente.": "Write what reward people get.",
    "Esa publicación ya no existe.": "That publication no longer exists.",
    "Eso ya no existe.": "That no longer exists.",
    "Vas muy rápido. Espera un momento y vuelve a probar.": "You're going very fast. Wait a moment and try again.",
    "No se ha podido hacer.": "It could not be done.",
    "Se borra para siempre, junto con sus estadísticas. Si solo quieres que deje de verse, púlsale a «Pausar».": "It is deleted for good, along with its statistics. If you only want to hide it, press “Pause”.",
    "5 minutos": "5 minutes",
    "30 minutos": "30 minutes",
    "3 horas": "3 hours",
    "1 día": "1 day",
    "Frutos de cáscara": "Tree nuts",
    "Empieza por una sección: «Para picar», «Bocadillos», «Bebidas»…": "Start with a section: “Nibbles”, “Sandwiches”, “Drinks”…",
    "Para picar": "Nibbles",
    "Tortilla de patata": "Spanish omelette",
    "¿Para qué sirve?": "What is it for?",
    "Una nota corta que sale en tu ficha: «hoy hay pulpo», «cerramos el lunes por obras», «ya tenemos terraza».": "A short note shown on your page: “octopus today”, “closed on Monday for works”, “the terrace is open”.",
    "¿Qué es una novedad?": "What is a news post?",
    "Desaparece de tu ficha. No se puede deshacer.": "It disappears from your page. This cannot be undone.",
    "¿Qué es esto?": "What is this?",
    "Ficha guardada": "Business page saved",
    "Horarios guardados": "Opening hours saved",
    "Invitación cancelada": "Invitation cancelled",
    "Gratis": "Free",
    "Confirmar": "Confirm",
    "Canjes": "Redemptions",
    "Quitada": "Removed",
